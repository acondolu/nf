...
Local Definition set := 𝓥.

Local Fixpoint undecorate {i} (x:Base.set i): set :=
match x with
...
Local Lemma mk_prop: forall p x, In (prop p) x <-> p.
Proof.
