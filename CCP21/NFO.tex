...
\coqdocindent{4.00em}
\coqexternalref{::type scope:x '<->' x}{http://coq.inria.fr/distrib/V8.11.0/stdlib//Coq.Init.Logic}{\coqdocnotation{\ensuremath{\leftrightarrow}}} \coqref{NFO.BoolExpr.eq bexpr}{\coqdocdefinition{eq\_bexpr}} \coqdocvariable{R} (\coqref{NFO.BoolExpr.map}{\coqdocdefinition{map}} \coqdocvariable{f} \coqdocvariable{e}) (\coqref{NFO.BoolExpr.map}{\coqdocdefinition{map}} \coqdocvariable{g} \coqdocvariable{e'}).\coqdoceol
\coqdocemptyline
\end{coqdoccode}
